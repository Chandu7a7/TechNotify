      ...
      <section className="container py-10">
        <div className=" grid md:grid-cols-3 py-5">
          ...
          <div className=" py-8 px-4 ">
            ...
            <p className="text-sm">
            TechNotify: Your go-to platform for real-time tech news, updates, and job opportunities. Stay informed, stay ahead, and explore the world of technology with us.{" "}
            </p>
            <br />
            {/* Social Handle */}
